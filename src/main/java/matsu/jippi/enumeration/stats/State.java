...
public enum State {
    ...
    JUMP_FORWARD(0x19), JUMP_BACKWARD(0x1A), FALL_FORWARD(0x1E), FALL_BACKWARD(0x1F), GRAB(0xD4), CLIFF_CATCH(0xFC), UNKNOWN(0xFF);
    ...
    public static State from(Integer animation) {
        if (animation == null)
            return null;
